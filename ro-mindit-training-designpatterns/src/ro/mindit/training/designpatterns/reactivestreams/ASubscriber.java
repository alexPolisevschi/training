 ...
 */
public class ASubscriber<T> implements Flow.Subscriber<T> {
    ...
    public void onNext(T item) {
        System.out.println("A received and persisting message: " + item);
    ...
    public void onComplete() {
        System.out.println("A: processed " + consumedElements.size() + " elements");
    }
}
